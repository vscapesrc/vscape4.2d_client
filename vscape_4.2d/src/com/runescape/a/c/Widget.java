      ...
      while(true) {
         ...
         do {
            ...
            if(var9.b >= var9.a.length) {
               ...
               var14.b(9, '\uc352', 22, 36);
               a('\uc353', "bank", 15, "Drag an item here to create a new tab");
               var14.b(10, '\uc353', 70, 36);
               a('\uc354', "bank", 15, "Drag an item here to create a new tab");
               var14.b(11, '\uc354', 118, 36);
               a('\uc355', "bank", 15, "Drag an item here to create a new tab");
               var14.b(12, '\uc355', 166, 36);
               a('\uc356', "bank", 15, "Drag an item here to create a new tab");
               var14.b(13, '\uc356', 214, 36);
               a('\uc357', "bank", 15, "Drag an item here to create a new tab");
               var14.b(14, '\uc357', 262, 36);
               a('\uc358', "bank", 15, "Drag an item here to create a new tab");
               var14.b(15, '\uc358', 310, 36);
               a('\uc359', "bank", 15, "Drag an item here to create a new tab");
               var14.b(16, '\uc359', 358, 36);
               a('\uc35a', "bank", 15, "Drag an item here to create a new tab");
               var14.b(17, '\uc35a', 406, 36);
