   ...
   public static void b() {
      try {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            ...
            var6.readFully(var4);
            if(M[var3] == null) {
               M[var3] = new SpriteGroup(new String(var4));
            }
